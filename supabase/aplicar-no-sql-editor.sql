-- ==============================================================
-- PECICLO — aplicar tudo de uma vez no SQL Editor do Supabase.
-- Cole este arquivo inteiro, clique em Run. É idempotente:
...
-- ---------- 4) VERIFICAÇÃO (deve mostrar 3 linhas, rls=t, policies=0) ----------
